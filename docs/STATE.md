...
| 2026-07-09 | **Cloud auto-review retired** — `.github/workflows/claude-code-review.yml` deleted (Sean's call). Reviews are local-only from here: multi-lens adversarial design + code review with impartial judge, per root `CLAUDE.md`. CI workflow unchanged. |
